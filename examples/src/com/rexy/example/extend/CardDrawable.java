...
public class CardDrawable extends Drawable {
    ...
    private static final int LINE_AVAIABLE = 8;

    private static final int DIRTY_PATH = 512;
    private static final int DIRTY_GRADIENT = 1024;
    private static final int DIRTY_AVAIABLE = 2048;
    ...
    protected void onBoundsChange(Rect bounds) {
        ...
        markCardLineDirty(DIRTY_PATH | DIRTY_GRADIENT);
    }
